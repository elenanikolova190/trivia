...
- Sample: `curl http://127.0.0.1:5000/questions -X POST -H "Content-Type: application/json" -d '{"question": "Which is the most polluted city in the world?", "answer": "New Delhi", "difficulty": 3, "category": "3" }'`
- Created question:
...
```
{
    ...
    "difficulty": 5,
    "id": 27,
    "question": "Which is the most polluted city in the world?"
}
```
...
{
  "created": 27,
  "question_created": "Which is the most polluted city in the world?",
  "questions": [
    {
      "answer": "Apollo 13",
      "category": 5,
